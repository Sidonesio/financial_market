...
# and load them
p_load(GetTDData, tidyverse, janitor, here, tidyquant)
...
# create data set with bonds daily returns
bond_return <- real_return %>%
  tq_transmute(select = yield_bid,
...
# save object
save(real_return, bond_return,
     file = here("brazil", "data", "01-bonds_10y_real_return.rda"))
